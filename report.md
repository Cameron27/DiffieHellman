...
Test message
```
The first line is the key (truncated), the second line is the received encoded message in hexadecimal and if you take `e6251e3434998b172278010cfb xor b2406d4014f4ee6451196669f1` you get the result `54657374206d6573736167650a`, which is the decoded message on line 4, so it is encoding and decoding correctly. The decoded message correctly translates to `Test message` whereas the encoded message translates to `.@m@...dQ.fi.`. As you can see the encoded message does appear to be scrambled with most of the bytes not event being 
